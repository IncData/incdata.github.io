<!DOCTYPE html>
	...
	<title>Se connecter &lsaquo; Ecole de Bachata, Salsa, Kizomba à Lyon &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="wp-login.php" method="post">
			...
			<div id="jetpack-sso-wrap__action">
				<a rel="nofollow" href="wp-login.php?action=jetpack-sso" class="jetpack-sso button button-primary"><span class="genericon genericon-wordpress"></span> Se connecter avec WordPress.com</a>
									<p>
						Vous pouvez maintenant gagner du temps à chaque fois que vous vous connectez, en liant votre compte WordPress.com à Ecole de Bachata, Salsa, Kizomba à Lyon.					</p>
							</div>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="index.html">&larr; Aller sur Ecole de Bachata, Salsa, Kizomba à Lyon</a>		</p>
			</div>
