<!DOCTYPE html>
	...
	<title>Se connecter &lsaquo; Ecole de Bachata, Salsa, Kizomba à Strasbourg &#8212; WordPress</title>
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="wp-login.php" method="post">
			...
			<div class="user-pass-wrap">
				...
				<input type="hidden" name="jetpack_protect_answer" value="3bbc6523f2cd9ea42eac9fb5268b40a8ff003cc5" />
			</div>
					<div id="jetpack-sso-wrap">
			

			<div id="jetpack-sso-wrap__action">
				<a rel="nofollow" href="wp-login.php?action=jetpack-sso" class="jetpack-sso button button-primary"><span class="genericon genericon-wordpress"></span> Se connecter avec WordPress.com</a>
									<p>
						Vous pouvez maintenant gagner du temps à chaque fois que vous vous connectez, en liant votre compte WordPress.com à Ecole de Bachata, Salsa, Kizomba à Strasbourg.					</p>
							</div>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="index.html">&larr; Aller sur Ecole de Bachata, Salsa, Kizomba à Strasbourg</a>		</p>
			</div>
				<div class="language-switcher">
				<form id="language-switcher" action="wp-login.php" method="get">
...
/* <![CDATA[ */
var userProfileL10n = {"user_id":"0","nonce":"50b3dcee4f"};
/* ]]> */
</script>
